...
const BiographyModal = ({ data, closeModal }: BiographyModalProps) => {
  return (
    <motion.div
    ...
    >
      ...
      >
        ...
        <div className="relative bg-linear-to-r from-pBlue to-liteBlue px-6 sm:px-10 py-6 sm:py-8 shrink-0">
          ...
          <div className="relative flex items-start gap-5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-blue-200/80 mt-1">
                {data.designationEn || "Chief Hydrographer"}
              </p>
              {/* Bengali Name & Designation - commented out */}
              {/* <h3 className="text-xl sm:text-2xl font-bold text-white leading-tight mt-2">
                {data.nameBn}
              </h3>
              <p className="text-sm text-blue-200/80 mt-1">
                {data.designationBn}
          ...
          <button
            onClick={closeModal}
            className="cursor-pointer absolute top-4 right-4 w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-white transition-colors duration-200"
        ...
        <div className="scrollbar-modern flex-1 overflow-y-auto px-4 lg:px-6 py-4 lg:py-6">
          ...
          <div className="mt-10 pt-8 border-t border-gray-100 flex items-center justify-between">
            <div>
              ...
              {/* Bengali footer - commented out */}
              {/* <p className="text-lg font-bold text-pBlue mt-2">
                {data.nameBn}
              </p>
              <p className="text-sm text-liteBlue font-medium tracking-wide uppercase mt-1">
                {data.designationBn}

  ...
  return (
    <section className="bg-white py-8 lg:py-20">
      <div className="container px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto space-y-12">
        ...
        {/* Summary Table */}
        <div>
          <h3 className="text-lg font-bold text-pBlue mb-4">
            Course Statistics
          </h3>
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-liteBlue text-white">
                  <th className="border border-liteBlue/40 px-3 py-3 text-center font-semibold">
                    Ser
                  </th>
              ...
              <tbody className="text-gray-700">
                ...
                <tr className="bg-white">
                  ...
                  <td className="border border-gray-200 px-3 py-3">
                    Long Hydrographic (Cat A)
                  </td>
                  <td className="border border-gray-200 px-3 py-3 text-center">
                    —
                  </td>
                  <td className="border border-gray-200 px-3 py-3 text-center whitespace-nowrap">
                    44 weeks
                  </td>
                  <td className="border border-gray-200 px-3 py-3 text-center">
                    —
                  ...
                  <td
                    className="border border-gray-200 px-3 py-3 text-center align-middle"
                    rowSpan={2}
                  >
                    Officers
                  </td>
                ...
                <tr className="bg-gray-50">
                  <td className="border border-gray-200 px-3 py-3 text-center"></td>
                  <td className="border border-gray-200 px-3 py-3">
                    Echo Sounder Data Acquisition and Processing
                  </td>
                  <td className="border border-gray-200 px-3 py-3 text-center">
                    06
                  </td>

        ...
        {data && (
          <div className="overflow-y-auto scrollbar-modern flex-1 mt-2 pr-2">
            <div className="grid grid-cols-2 gap-3">
              ...
              <DetailRow
                label="Name of Ship / Sender"
                value={data.nameOfShip}
              />
              ...
              <DetailRow
                label="General Locality"
                value={data.generalLocality}
              />
              ...
              <DetailRow
                label="BN Charts Affected"
                value={data.bnChartsAffected}
              />
              <DetailRow label="Edition" value={data.edition} />
              <DetailRow
                label="Latest Notices to Mariners"
                value={data.latestNoticesToMariners}
              />
              <DetailRow
                label="Replacement Copy of Chart No"
                value={data.replacementCopyOfChartNo}
              />
              <DetailRow
                label="Replacement Required"
                value={data.replacementRequired}
              />

              <SectionLabel title="ENCs & ECDIS" />
              <DetailRow label="ENCs Affected" value={data.encsAffected} />
              <DetailRow
                label="Latest Update Applied"
                value={data.latestUpdateApplied}
              />
              <DetailRow
                label="Model and Age of ECDIS"
                value={data.modelAndAgeOfECDIS}
              />

              <SectionLabel title="Publications" />
              <DetailRow
                label="Publications Affected"
                value={data.publicationsAffected}
              />
              <DetailRow
                label="Date of Latest Supplement"
                value={data.dateOfLatestSupplement}
              />
              ...
              <div className="col-span-2 bg-gray-50 rounded-lg p-3 border border-gray-100">
                ...
                <p className="text-sm text-secondary-dark whitespace-pre-wrap">
                  {data.detailsOfObservation || "—"}
                </p>
              </div>
              <DetailRow
                label="Name of Observer / Reporter"
                value={data.nameOfObserver}
              />
            </div>
          </div>
        )}

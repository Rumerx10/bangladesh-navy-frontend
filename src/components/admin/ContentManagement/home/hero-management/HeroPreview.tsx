            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {data.images.map((image: string | File, index: number) => (
                ...
                >
                  ...
                  <div className="absolute bottom-2 right-2 bg-black/60 backdrop-blur-sm text-white text-xs h-5 w-5 flex items-center justify-center rounded-full transition-opacity duration-300">
                    {index + 1}
                  </div>
                </div>
              ))}

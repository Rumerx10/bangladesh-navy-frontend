...
export const biographyManagementSchema = yup.object({
  ...
  designationEn: yup.string().required("English designation is required").trim(),
...
export type BiographyManagementSchemaForm = yup.InferType<typeof biographyManagementSchema>;
...
// --- Commented out — Title/Subtitle/Image/Key Milestones/Timeline are not part of
// the current /history API. Kept for potential future re-enablement. ---

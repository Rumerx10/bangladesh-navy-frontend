// src/modules/admin/hero-management/components/Form/ControlledNoticeField.tsx
"use client";
...
interface ControlledNoticeFieldProps {
  name: string;
  placeholder?: string;
  className?: string;
  disabled?: boolean;
...
const ControlledNoticeField = ({
  name,
  placeholder = "Add a notice...",
  className,
  disabled,
}: ControlledNoticeFieldProps) => {
...
export default ControlledNoticeField;
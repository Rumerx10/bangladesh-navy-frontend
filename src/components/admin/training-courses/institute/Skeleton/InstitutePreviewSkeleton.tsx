const InstitutePreviewSkeleton = () => {
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden animate-pulse">
      <div className="relative bg-linear-to-r from-primary/5 via-primary/10 to-transparent px-8 py-6 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="bg-gray-200 h-6 w-56 rounded" />
            <div className="bg-gray-200 h-4 w-64 rounded mt-1" />
          </div>
        </div>
      ...
      <div className="p-8 pt-10 space-y-8">
        ...
        <div className="bg-gray-50 rounded-xl p-5 border border-gray-100 space-y-2">
          <div className="bg-gray-200 h-4 w-20 rounded mb-3" />
          {[1, 2, 3, 4].map((i) => (
        ...
        <div className="bg-gray-50 rounded-xl p-5 border border-gray-100 space-y-2">
          <div className="bg-gray-200 h-4 w-36 rounded mb-3" />
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-gray-200 h-4 w-full rounded" />
          ))}
        </div>
...
export default InstitutePreviewSkeleton;

                    ...
                    {order.paymentStatus === "REFUNDED" && (
                      <div className="flex items-center gap-2 bg-white/80 rounded-lg px-3 py-2 border border-red-200 mt-1">
                        ...
                        <p className="text-xs text-red-700 font-medium">
                          ...
                          processed via {order.paymentMethod}
                        </p>
                      </div>
                    )}
                  </div>
              ...
              order.returnReason && (
                <div className="border border-orange-200 rounded-xl bg-orange-50 overflow-hidden">
                  <div className="flex items-center gap-2 px-4 sm:px-5 py-3 border-b border-orange-200">
                    <span className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center text-orange-600 text-xs">
                      ↩
                    </span>
                      ...
                      return (
                        ...
                        >
                          {idx < STATUS_FLOW.length - 1 && (
                            <div
                              className={`absolute left-2.25 top-5 w-0.5 h-[calc(100%-12px)] ${isDone ? "bg-primary" : "bg-border"}`}
                            />
                          )}
                          <div
                            className={`w-4.5 h-4.5 rounded-full border-2 shrink-0 mt-0.5 ${
                          ...
                          <div>
                            <p
                              className={`text-sm font-medium capitalize ${isDone || isActive ? "text-foreground" : "text-foreground/45"}`}
                            >
                              {status}
                            </p>
                            {isActive && (
